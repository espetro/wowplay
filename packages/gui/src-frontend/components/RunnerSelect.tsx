...
export function RunnerSelect(props: {
  ...
  return (
    ...
    >
      ...
      <Select.Control>
        <Select.Trigger data-testid="runner-select-trigger" class="w-full flex items-center justify-between border rounded-lg px-3 py-2.5 text-left hover:border-gray-400 focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200">
          ...
          <For each={props.runners}>
            {(runner) => (
              ...
              >
                ...
                <Select.ItemIndicator class="text-primary">✓</Select.ItemIndicator>
              </Select.Item>
            )}
          </For>
        </Select.Content>
