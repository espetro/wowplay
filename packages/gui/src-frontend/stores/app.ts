...
// Derived getters
export const isSetupComplete = () => store.config.runner !== null && store.config.wow_dir !== null;
export const visibleAlerts = () => store.alerts.filter(a => a.type !== 'info' || store.config.show_alerts);
